...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09/06/2018 às 05:13
...
(1, 'JOAO PEDRO', '07/06/2018', 'A Vista', 'A', 123),
(2, 'PEDRO DE PAULA', '06/05/2018', 'A Prazo', 'I', 159),
(3, 'PAULA ARAUJO', '23/05/2018', 'A Vista', 'A', 369),
(4, 'JOSE GUILHERME', '12/06/2018', 'A Prazo', 'A', 123);
...
--
ALTER TABLE `itempedido`
  MODIFY `itp_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `itempedido`
  ADD CONSTRAINT `fk_ped_itp` FOREIGN KEY (`ped_codigo`) REFERENCES `pedido` (`ped_codigo`) ON DELETE CASCADE;
--
-- Banco de dados: `neto`
--
CREATE DATABASE IF NOT EXISTS `neto` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `neto`;
...
CREATE TABLE `cores` (
  ...
  `cor_descricao` varchar(15) DEFAULT NULL,
  `cor_referencia` char(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `cores` (`cor_codigo`, `cor_descricao`, `cor_referencia`) VALUES
(3, 'Azul', '444'),
(4, 'Preto', '555');
...
--
ALTER TABLE `cores`
  MODIFY `cor_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
('comercio', 'itempedido', 'ped_codigo');
...
('root', 'comercio', 'itempedido', '{\"CREATE_TIME\":\"2018-06-07 22:59:33\"}', '2018-06-09 02:25:30'),
('root', 'neto', 'cores', '{\"sorted_col\":\"`cores`.`cor_codigo` ASC\"}', '2018-06-07 23:08:45');
...
('root', '2018-06-09 02:25:23', '{\"lang\":\"pt_BR\",\"Console\\/Mode\":\"show\"}');
